		...
		<ul class="flex flex-col">				
            ...
            @foreach ($course->posts as $post)
                <li class="flex items-center text-gray-600 mt-2">
                    {{ $post->title }}
                    @if($post->free)
                        <span class="text-xs text-gray-500 font-semibold bg-gray-300 rounded-full ml-auto px-2">Free</span>
                    @endif
                </li> 
            @endforeach
...
<div class="text-center mt-12">
    <h1 class="text-3xl text-gray-700 mb-2 uppercase">Cursos Relacionados</h1>
